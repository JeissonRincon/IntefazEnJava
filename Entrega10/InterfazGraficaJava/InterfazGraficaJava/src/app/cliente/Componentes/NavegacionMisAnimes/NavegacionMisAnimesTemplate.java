...
public class NavegacionMisAnimesTemplate extends JPanel{
    ...
    public void crearJButtons(){
        ...
        bSiguiendo = sObjetosGraficos.construirJButton("   Siguiendo", 30, 10, 200, 30,sRecursos.getcMano(), iAux, 
                sRecursos.getFontBotones(), Color.DARK_GRAY, Color.WHITE, null, "l", false);
        this.bSiguiendo.addActionListener(navegacionMisAnimesComponent);
        bSiguiendo.addMouseListener(navegacionMisAnimesComponent);
        this.add(bSiguiendo);
        ...
        bFavoritos.addMouseListener(navegacionMisAnimesComponent);
        this.add(bFavoritos);
        ...
        bVerLuego.addMouseListener(navegacionMisAnimesComponent);
        this.add(bVerLuego);
