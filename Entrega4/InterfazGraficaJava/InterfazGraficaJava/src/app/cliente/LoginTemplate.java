...
public class LoginTemplate extends JFrame{
    ...
    public void crearPanels(){
        ...
        pDerecha = sObjetosGraficos.construirJPanel(600, 0, 400, 500, Color.WHITE, null);
        this.add(pDerecha);
    ...
    tNombreUsuario = sObjetosGraficos.construirJTextField("Usuario", (pDerecha.getWidth() - 300)/2,
            200, 300, 40, Color.WHITE, Color.DARK_GRAY, Color.blue, null, sRecursos.getBorderInferiorNegro(), "c");
    ...
    public void crearJLabels(){
        ...
        lTituloApp = sObjetosGraficos.construirJLabel("INICIAR SESION", 125, 120, 150, 30, null,
                Color.BLACK, null, sRecursos.getFontIniciarSesion(), "c");
        pDerecha.add(lTituloApp);
        
        lUsuario = sObjetosGraficos.construirJLabel("Usuario", 100, 160, 200, 30, null,
                Color.LIGHT_GRAY, null, sRecursos.getFontSubtitulos(), "c");
        pDerecha.add(lUsuario);
        
        lContraseña = sObjetosGraficos.construirJLabel("Contraseña", 100, 250, 200, 30, null,
                Color.LIGHT_GRAY, null, sRecursos.getFontSubtitulos(), "c");        
    ...
    public void crearJPasswordFields(){
        ...
        tClaveUsuario = sObjetosGraficos.construirJPasswordField("Contraseña", (pDerecha.getWidth() - tNombreUsuario.getWidth())/2,
                290, 300, 40, Color.WHITE, Color.DARK_GRAY, Color.BLUE, null, sRecursos.getBorderInferiorNegro(), "c");
    ...
    public void crearJButtons(){
        ...
        bEntrar = sObjetosGraficos.construirJButton("INICIAR SESION",(pDerecha.getWidth() - 250)/2 ,
                350, 250, 40,sRecursos.getcMano(),null, null, sRecursos.getColorNegro(), Color.WHITE, null, "c", true);
